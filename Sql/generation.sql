...
insert into users(user_id,user_name,user_email,user_password,first_name,last_name,user_cf,cap) values('2','davidegreeen','davide@green.it','Greendavide1','Davide','Lapi','LPADVD97B15C523Y','20096');
