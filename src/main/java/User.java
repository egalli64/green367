...
public class User {
	...
	public User(int user_id, String user_name, String user_password, String first_name, String last_name, int cap,
			String user_email, String user_cf) {
		this.user_id = user_id;
		this.user_name = user_name;
		this.user_password = user_password;
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_name=" + user_name + ", user_password=" + user_password
				+ ", user_cf=" + user_cf + ", first_name=" + first_name + ", last_name=" + last_name + ", cap=" + cap
