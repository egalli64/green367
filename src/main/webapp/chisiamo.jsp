...
<body>
	...
	<div class="central">
		...
		<div class="row">
			...
			<div class="col">
				<figure>
					<a href="davideCV/myCB.html"><img src="davideCV/davideLapi.jpg"
						alt="Davide Lapi" width="150"></a>
					<figcaption>
			...
			<div class="col">
				<figure>
					<a href=" "><img src=" " alt="Francesco Fasciano" width="150"></a>
					<figcaption>
			...
			<div class="col">
				<figure>
					<a href=" "><img src=" " alt="Mauro Forte" width="150"></a>
					<figcaption>
		...
		<div class="row">
			...
			<div class="col">
				<figure>
					<a href=" "><img src=" " alt="Elisa Mani" width="150"></a>
					<figcaption>
			...
			<div class="col">
				<figure>
					<a href=" "><img src=" " alt="Emilia Faraci" width="150"></a>
					<figcaption>
			...
			<div class="col">
				<figure>
					<a href=" "><img src=" " alt="Patrizia Gironi" width="150"></a>
					<figcaption>
		...
		<p align="center">Cliccando sulle immagini potrai trovare
			informazioni su ogniuno di loro</p>
			
		<p align="center" class="text">
			Se dovessi avere qualsiasi dubbio nell'utilizzo del sito, non esitare a <a
				href="./contact.jsp"> contattarci </a> !
		</p>
	</div>
