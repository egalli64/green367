...
<body>
	...
	<div id="liste">
		...
		<div class="row">
			...
			<div class="col" id="l1">
				<legend id="legend-register">OSPEDALE DI VIZZOLO PREDABISSI</legend>
				<ul class="list-group">
		...
		<div class="row">
			...
			<div class="col-xl-4" id="l1">
				<legend id="legend-register">PRESIDIO OSPEDALIERO DI ROVATO</legend>
				<ul class="list-group">
			...
			<div class="col-xl-4" id="l1">
				<legend id="legend-register">OSPEDALE S. MARIA DELLE STELLE
					MELZO</legend>
				<ul class="list-group">
