	...
	<div id="wrap" class="container">
		<div class="row">
			<div id="page"
				...
				<hr>
				<h1 class="page-title">
                    Ospedale "Pesenti Fenaroli" di Alzano Lombardo </h1>
                        ...
                        <div class="table-responsive">
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="text-align: center;"><strong>Ospedale "Pesenti Fenaroli" - Alzano</strong></p>
                                            <p style="text-align: center;"><strong>Via Mazzini&nbsp;88,
                                                    21047&nbsp;Alzano Lombardo (BG)</strong></p>
		...
		<hr>
		 ...
		 <div id="copyrightArea" class="text-center">
            <p>Via Mazzini 88, 21047 Alzano Lombardo (BG) - Telefono: 02 98051 - Fax: 02 98058254 - C.F. e P.I. 09320650964</p>
            <hr>
            <p>© 2020 Green Team</p>
        </div>
		<hr>
