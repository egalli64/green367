    ...
    <div class="row">
        ...
        <div class="col-5">
            <div class="jumbotron index-jumbo">
                ...
                <p id="jumbo-text">
                    GreenHospital è un progetto rivoluzionario nell'assistenza medica:
                    non perdere tempo, prenota ora la tua visita medica da casa, gratis!
                    Potrai scegliere in quale ospedale recarti o scegliere quello in cui è possibile prenotare prima.
                </p>
            </div>
        </div>
